...
def compute_delta2_bootstrapped_diff(x1, x2, x3, x4, is_paired,
                              resamples=5000, random_seed=12345):
    """
    ...
    Returns
    -------
    out_delta_g: array-like
        bootstraped result of deltas' g
    delta_g: float
        empirical result of deltas' g
    deltadelta: array-like
        bootstraped result of delta-delta
    """
